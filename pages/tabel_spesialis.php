      ...
      <table class="table table_spesialis">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= $row['harga_spesialisasi'] ?></td>
            <td>
              <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#edit_spesialis_<?= $row['id_spesialisasi']?>" >Edit</button> |
               <button
               type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#delete_spesialis_<?= $row['id_spesialisasi']?>" >
                 Delete
               </button>
             </td>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="process/spesialisasi/edit_process.php" method="post">
                    ...
                    <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Harga Spesialis:</label>
                      <input type="text" class="form-control" id="recipient-name" name="harga_spesialisasi" value="<?= $row['harga_spesialisasi'] ?>">
                    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="process/spesialisasi/insert_process.php">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Harga Spesialis:</label>
            <input type="text" class="form-control" id="recipient-name" name="harga_spesialisasi">
          </div>
