...
<?php
	...
	public function tambahSpesialisasi($kode_spesialisasi, $nama_spesialisasi, $harga_spesialisasi){

			$sql="INSERT INTO tspesialisasi (kode_spesialisasi,nama_spesialisasi,harga_spesialisasi) VALUES(?,?,?)";
			$stmt = $this->pdo->prepare($sql);
			$stmt->execute([
				$kode_spesialisasi,$nama_spesialisasi,$harga_spesialisasi
			]);
	}
